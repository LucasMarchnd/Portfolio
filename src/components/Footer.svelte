<footer class="py-10 sm:py-12 bg-slate-50 border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    ...
    <p class="text-slate-400 mt-8">
        Made with <span class="text-red-500">&hearts;</span> by Lucas and with <a class="text-violet-400" href="https://svelte.dev/" target="_blank">Svelte</a>
    </p>
</footer>
